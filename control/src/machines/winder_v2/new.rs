mod winder2_imports {
    ...
    pub use super::super::{WinderV2, Winder2Mode};
...
use qitech_framework::machine::{BuildContext, MachineBuild, error::{BuildError, BuildResult}};
pub use winder2_imports::*;

impl MachineBuild for WinderV2 {
    fn build(ctx: BuildContext) -> BuildResult<Self> {
        if ctx.ident_unique().identification == WinderV2::MACHINE_IDENTIFICATION {
            Self::new_normal(ctx)
        } else if ctx.identification.machine_ident == WinderV2::MACHINE_IDENTIFICATION_7031_SPOOL {
...
impl WinderV2 {
    fn new_normal(ctx: BuildContext) -> BuildResult<Self> {
        let _ek1100 = ctx.try_get_ethercat_device_and_addr_by_role::<EK1100>(0)?;
        let el2002 = ctx.try_get_ethercat_device_and_addr_by_role::<EL2002>(1)?;
        let el7041 = ctx.try_get_ethercat_device_and_addr_by_role::<EL7041_0052>(2)?;
        let el7031 = ctx.try_get_ethercat_device_and_addr_by_role::<EL7031>(3)?;
        let el7031_0030 = ctx.try_get_ethercat_device_and_addr_by_role::<EL7031_0030>(4)?;
    ...
    fn new_winder_spool_7031(ctx: BuildContext) -> BuildResult<Self> {
        let _ek1100 = ctx.try_get_ethercat_device_and_addr_by_role::<EK1100>(0)?;
        let el2002 = ctx.try_get_ethercat_device_and_addr_by_role::<EL2002>(1)?;
        let el7031_0030_spool = ctx.try_get_ethercat_device_and_addr_by_role::<EL7031_0030>(2)?;
        let el7031 = ctx.try_get_ethercat_device_and_addr_by_role::<EL7031>(3)?;
        let el7031_0030 = ctx.try_get_ethercat_device_and_addr_by_role::<EL7031_0030>(4)?;
