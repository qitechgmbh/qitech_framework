...
use qitech_framework::machine::resource::ConfigPropertyCapabilities;
use qitech_framework::machine::resource::ConfigPropertyWriteCapability;
...
impl LaserV1 {
    pub fn diameter_target_constraints(&self) -> ConfigPropertyCapabilities<millimeter> {
        ConfigPropertyCapabilities {
            writable: ConfigPropertyWriteCapability::Allowed,
            constraints: NumericConfigPropertyConstraints {
                min: Some(Length::new::<millimeter>(0.0)),
                max: Some(Length::new::<millimeter>(0.0)),
            },
        }
    }
}
